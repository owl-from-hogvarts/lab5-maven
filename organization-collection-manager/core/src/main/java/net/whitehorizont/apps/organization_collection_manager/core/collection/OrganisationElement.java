...
import net.whitehorizont.apps.organization_collection_manager.core.collection.Address.AddressPrototype;
import net.whitehorizont.apps.organization_collection_manager.core.collection.Address.AddressRawData;
...
public class OrganisationElement implements ICollectionElement<OrganisationElement.OrganisationElementPrototype> {
  ...
  private static final FieldMetadataWithValidators<Date, Object> CREATION_DATE_METADATA = 
      new FieldMetadataWithValidators.Metadata<Date, Object>()
      .setDisplayedName("Creation date")
      .setRequired("Creation field is autogenerated filed! There is an error in program!")
      .build();
  ...
  private final FieldDefinition<Date, Object> creationDate;
  ...
  public FieldDefinition<Date, Object> getCreationDate() {
    return creationDate;
  }
  ...
  public OrganisationElement(ICollection<OrganisationElementPrototype, OrganisationElement> collection,
    ...
    this.creationDate = new FieldDefinition<>(CREATION_DATE_METADATA, prototype.creationTime.getValue(), collection);
  ...
  public static class OrganisationElementRawData {
    ...
    private AddressRawData address = new AddressRawData();
    private OrganisationType type;
    private Double annualTurnover;
    private Date creationTime;

    private OrganisationElementRawData address(AddressRawData address) {
      this.address = address;
      return this;
    }

    private OrganisationElementRawData creationTime(Date creationTime) {
  ...
  public static class OrganisationElementPrototype
    ...
    private AddressPrototype address = new AddressPrototype();
    ...
    private final WriteableFieldDefinition<Date> creationTime;
    ...
    public OrganisationElementPrototype() {
      try {
        ...
        this.creationTime = new WriteableFieldDefinition<Date>(CREATION_DATE_METADATA, Date.from(Instant.now()));
      } catch (ValidationError e) {
    ...
    public OrganisationElementRawData getRawElementData() {
      return new OrganisationElementRawData()
        ...
        .address(address.getRawElementData())
        .type(this.type.getValue())
        .annualTurnover(this.annualTurnover.getValue())
        .creationTime(this.creationTime.getValue());
    }
    ...
    public IElementPrototype<OrganisationElementRawData> setFromRawData(OrganisationElementRawData rawData)
      ...
      this.address.setFromRawData(rawData.address);
      this.type.setValue(rawData.type);
      this.annualTurnover.setValue(rawData.annualTurnover);
      this.creationTime.setValue(rawData.creationTime);
